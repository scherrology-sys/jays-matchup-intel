...
|------|----------|---------|----------|-------|
| 4-2-26  | CWS | Burke (bulk) / Taylor (opener) RHP | G. Springer (.410) | [Preview](https://scherrology-sys.github.io/jays-matchup-intel/games/2026-04-02-burke-taylor/) · Retro pending |
...
**Colorado series: TOR 1-2 · Chicago White Sox series begins 4-2-26**
