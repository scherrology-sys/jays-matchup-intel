...
# MIN @ TOR · April 9, 2026 · Target Field · Study observation 11
# =============================================================================
#
...
tournament <- run_baseline_tournament(
  champion_exp_df = champion_results,
  team_woba_2026  = team_woba_2026,
  pitcher_era     = 3.5,
  park_code       = PARK,
...
champion_results |>
  ...
  write_csv(sprintf("outputs/rankings/champion_rank_%s_wr.csv", GAME_DATE))
